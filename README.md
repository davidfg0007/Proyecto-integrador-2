...
|------|-----|-------------|
| GET | http://127.0.0.1:3005/muebles | Obtiene los registros (permite filtros) |
| GET | http://127.0.0.1:3005/muebles/1 | Obtiene un registro en específico |
| POST | http://127.0.0.1:3005/muebles | Crea un nuevo registro |
| PUT | http://127.0.0.1:3005/muebles/1 | Modifica un registro en específico |
| DELETE | http://127.0.0.1:3005/muebles/1 | Elimina un registro en específico |
